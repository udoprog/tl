...
units = [
  Family('net', (
    ...
    Unit('MB', "megabyte",  8 * 1e9),
    Unit('GB', "gigabyte",  8 * 1e12),
    Unit('TB', "terabyte",  8 * 1e15),
    Unit('PB', "petabyte",  8 * 1e18),
    Unit('EB', "exabyte",   8 * 1e21),
    Unit('ZB', "zetabyte",  8 * 1e24),
    Unit('YB', "yottabyte", 8 * 1e27),
    Unit('KiB', "kibibyte", 8 * 1024),
